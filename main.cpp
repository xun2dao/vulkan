...
private:
  void initWindow() {
    ...
    glfwWindowHint(GLFW_CLIENT_API, GLFW_NO_API); // Client Api 是专门为了OpenGL准备的。
  ...
  void createInstance() {
    ...
    requiredExtensions.emplace_back(
        VK_KHR_PORTABILITY_ENUMERATION_EXTENSION_NAME);  // VK_KHR_portability_enumeration 专门为MacOS准备的
